...
void MyOctant::Init(void)
{
	...
	for (uint i = 0; i < iEntityCount; ++i)
	{
		...
		//if (v3Position.x < 0.0f) // left of center
		//{
		//	if (v3Position.x < -17.0f) // left of left plane
		//		m_pEntityMngr->AddDimension(-1, 1);
		//	else
		//		m_pEntityMngr->AddDimension(-1, 2);
		//}
		//else if (v3Position.x > 0.0f) // right of center
		//{
		//	if (v3Position.x > 17.0f) // right of right plane
